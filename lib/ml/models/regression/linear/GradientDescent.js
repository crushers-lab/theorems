...
var GradientDescent = /** @class */ (function (_super) {
    ...
    Object.defineProperty(GradientDescent.prototype, "estimator", {
        get: function () {
    ...
    GradientDescent.getTheta = function (n) {
        var theta = [];
        for (var i = 0; i < n; i++) {
    ...
    GradientDescent.prototype.fit = function (X, y, iterations, rate) {
    ...
    GradientDescent.prototype.predict = function (X) {
        var _this = this;
        if (!this._estimator) {
    ...
    GradientDescent.prototype.calculate = function () {
        ...
        var theta = new Matrix_1.MatrixOp([GradientDescent.getTheta(x.n)]).transpose();
        var xt = x.transpose();
    ...
    GradientDescent.prototype._calculateRow = function (vector) {
